...
import org.firstinspires.ftc.teamcode.Utilities.Swerve.AdvSwerveModule;
...
//TODO: Redo all swerve References
//TODO: Get localizer bullshit sorted
...
public class SampleSwerveDrive extends SwerveDrive {
    ...
    public AdvSwerveModule moduleFL, moduleBL, moduleBR, moduleFR;
    public List<AdvSwerveModule> modules;
...
//TODO: Change multipliers on servo positions
        moduleFL = new AdvSwerveModule(hardwareMap, "flm", "fls", "fle", 1, 1);
        moduleBL = new AdvSwerveModule(hardwareMap, "blm", "bls", "ble", 1, 1);
        moduleBR = new AdvSwerveModule(hardwareMap, "brm", "brs", "bre", 1, 1);
        moduleFR = new AdvSwerveModule(hardwareMap, "frm", "frs", "fre", 1, 1);

        modules = Arrays.asList(moduleFL, moduleBL, moduleBR, moduleFR);
    ...
    public void updateModules(){//TODO: Update function for SwerveModules
//        for (AdvSwerveModule m : modules) m.update();
//        PhotonCore.CONTROL_HUB.clearBulkCache();
    ...
    public List<Double> getWheelPositions() {
        ...
        for (AdvSwerveModule m : modules) wheelPositions.add(m.getCurrentAngle());
    ...
    public List<Double> getWheelVelocities() {
        ...
        for (AdvSwerveModule m : modules) wheelVelocities.add(m.getMotorPower());
        return wheelVelocities;
    }

    @Override
    public void setMotorPowers(double v, double v1, double v2, double v3) {
        moduleFL.setMotorPower(v);
        moduleBL.setMotorPower(v1);
        moduleBR.setMotorPower(v2);
        moduleFR.setMotorPower(v3);
    }
    ...
    public List<Double> getModuleOrientations() {
        ...
        for (AdvSwerveModule m : modules) moduleOrientations.add(m.getCurrentAngle());
    ...
    public void setModuleOrientations(double v, double v1, double v2, double v3) {
        moduleFL.setServoTarget(v);
        moduleBL.setServoTarget(v1);
        moduleBR.setServoTarget(v2);
        moduleFR.setServoTarget(v3);
    }

    public void setModuleVelocities(double v, double v1, double v2, double v3) {
        moduleFL.setServoPower(v);
        moduleBL.setServoPower(v1);
        moduleBR.setServoPower(v2);
        moduleFR.setServoPower(v3);
